"""Script en Python para generar una red en la que cada nodo representa un item de mi CV."""
#Maria Ines Aran <aranmariaines@gmail.com>
...
#Creación de variable G
G=nx.DiGraph()

#Vector de nodos nivel 0
nodoyo=["MARIA INES"]

#Vectores de nodos nivel 1 y 2
nodosedu=["EDUCACION",
...
#Creación y agrupamiento de nodos 
i=0
while i<4:
...
#Generación de JSON con datos de la red
